...
//WebUI.delay(3)
//
//WebUI.click(findTestObject('OASIS_SOC/Tab12_ADLs_IADLs/Musculoskeletal_Status/Muscle_strength/chb_Fair'))
//
//WebUI.delay(3)
//
//WebUI.click(findTestObject('OASIS_SOC/Tab12_ADLs_IADLs/Musculoskeletal_Status/Muscle_strength/chb_Weak'))
//
//WebUI.delay(6)
//
...
//WebUI.delay(3)
//
//WebUI.click(findTestObject('OASIS_SOC/Tab12_ADLs_IADLs/Musculoskeletal_Status/Range_of_motion/chb_Limited'))
//
//WebUI.delay(3)
//
...
//WebUI.delay(3)
//
//WebUI.click(findTestObject('OASIS_SOC/Tab12_ADLs_IADLs/Musculoskeletal_Status/Amputation/txt_UE'))
//
//WebUI.delay(3)
//
...
WebUI.click(findTestObject('OASIS_SOC/Tab12_ADLs_IADLs/Musculoskeletal_Status/Fracture/New/Character/txt_Swelling'))
...
WebUI.click(findTestObject('OASIS_SOC/Tab12_ADLs_IADLs/Musculoskeletal_Status/Fracture/New/Character/txt_Pallor'))
...
WebUI.click(findTestObject('OASIS_SOC/Tab12_ADLs_IADLs/Musculoskeletal_Status/Fracture/New/Character/txt_Pain'))

WebUI.delay(3)

WebUI.click(findTestObject('OASIS_SOC/Tab12_ADLs_IADLs/Musculoskeletal_Status/Fracture/New/Skin_Temperature/chb_Warm'))
...
WebUI.click(findTestObject('OASIS_SOC/Tab12_ADLs_IADLs/Musculoskeletal_Status/Fracture/New/Mobility/txt_Able_to_move'))
...
WebUI.click(findTestObject('OASIS_SOC/Tab12_ADLs_IADLs/Musculoskeletal_Status/Fracture/New/Mobility/txt_Unable_to_move'))
...
WebUI.click(findTestObject('OASIS_SOC/Tab12_ADLs_IADLs/Musculoskeletal_Status/Fracture/New/Capillary_refill/chb_greaterthat_3_sec'))

WebUI.delay(3)

WebUI.click(findTestObject('OASIS_SOC/Tab12_ADLs_IADLs/Musculoskeletal_Status/Fracture/chb_Old'))
...
WebUI.setText(findTestObject('OASIS_SOC/Tab12_ADLs_IADLs/Functional_Limitations/txt_Other'), '')
...
WebUI.setText(findTestObject('OASIS_SOC/Tab12_ADLs_IADLs/Activities_Permitted/txt_Other'), '')
